...
@section('title','Todos mis estudios')
                    ...
                    <table id="zero-configurationo" class="display table nowrap table-striped table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('showStudy',['id' => $study->id])}}" title="VER" class="label theme-bg text-white f-12 btn-rounded"><i class="feather icon-eye mr-0"></i></a>
                                    <!--
