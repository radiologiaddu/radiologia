...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="640" style="width:640px;max-width:640px;" Simpli>
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="https://app.ddu.mx/image/original.png" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
    </td>
  </tr>
  <tr>
    <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
...
<v:fill type="frame" src="images/header-2.jpg" color="#F4F4F4" />
...
<div>
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
    <tr>
      <td align="center" background="{{ asset('/image/header-16.jpg') }}" data-bg-image   style="background-size:cover;background-position:center top; border-radius: 36px;">
        @if (isset( $message))
          <?php
            $qrCodeAsPng = QrCode::format('png')->size(600)->generate(route('code',['id' =>$details['qr']]));
          ?>
          <img id="QrImg" src="{{ $message->embedData($qrCodeAsPng, 'nameForAttachment.png') }}" />
        @else
          {!! QrCode::size(600)->generate(route('code',['id' =>$details['qr']])); !!}
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="600" style="width:600px;max-width:600px;">
    <tr>
      <td height="0" valign="bottom" class="container-padding" style="font-size:640px;line-height:0px;" Simpli>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
        ...
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit Simpli>
                  {{$details['doctor']}} te ha enviado el código para que acudas a DDU a realizar el estudio que necesitas para avanzar con tu tratamiento.
                </div>
                <br>
                <div mc:edit Simpli>
                  Preséntate en la entrada de DDU y muestra tu QR 
                  <br>
                  <strong>¡CON ÉL NO TENDRÁS QUE HACER FILA!</strong>
                  <br>
                  Agenda tu cita y llega a tiempo. Cuentas con 10 min. de tolerancia, de lo contrario tendrás formarte. 
                  <br>
                </div>
                <br>
                <div mc:edit Simpli>
                  Solamente recuerda: 
                  <br>
                  <strong>LAVARTE BIEN LOS DIENTES</strong>
                </div>
              </singleline>
          </td>
        </tr>      
        <tr>
          <td height="40"  style="border-bottom: 4px dotted #E4E4E4;font-size:40px;line-height:40px;">&nbsp;</td>
        </tr>
        <tr>
          <td height="20" style="font-size:20px;line-height:20px;" Simpli>&nbsp;</td>
        </tr>
        <tr>
          <td class="center-text" Simpli align="center" style="font-size:20px;line-height:20px;" Simpli>
            Nos ubicamos en Fray José de Arlegui # 795 Col. Virreyes San Luis Potosí, SLP
            <br>
            Nuestros horarios de atención son de: LUNES A VIERNES 09:30-19:00 HRS. SÁBADOS DE 09:30-14:30 HRS
          </td>
        </tr>
        <tr>
          <td align="center">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
              ...
              <tr>
                <td align="center">
                  ...
                  <!-- column -->
                  <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row m-padding-top20" width="235" style="width:235px;max-width:235px;">
                    <tr>
                      <td align="center"  Simpli bgcolor="#6e7bde" style="border-radius: 25px;">
                        <!--[if (gte mso 9)|(IE)]>
                  ...
                  <!-- column -->
                  <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="235" style="width:235px;max-width:235px;">
                    <tr>
                      <td align="center"  Simpli bgcolor="#6e7bde" style="border-radius: 25px;">
                        <!--[if (gte mso 9)|(IE)]>
                          <table border="0" cellpadding="0" cellspacing="0" align="center">
              ...
              <tr>
                <td height="10" style="font-size:10px;line-height:10px;" Simpli>&nbsp;</td>
              </tr>
            </table>
            <!-- Content -->
          </td>
...
@foreach ($details['studies'] as $study)
  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding25" width="600" style="width:600px;max-width:600px;" Simpli>
    <!-- content-4B -->
    <tr>
      <td align="center" Simpli bgcolor="#FFFFFF" style="border-radius:0;">
        <!-- content -->
        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
          <tr>
            <td height="20" style="font-size:20px;line-height:20px;" Simpli>&nbsp;</td>
          ...
          <tr>
            <td align="center" valign="top" width="100%" style="width:100%;max-width:100%;">
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr>
                  <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                      <singleline>
                        <div mc:edit Simpli>
                          {{$study->title}}
                        </div>
                ...
                @foreach ($study->questions as $question)
                  <tr>
                    <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                        <singleline>
                          <div mc:edit Simpli>
                            {{$question->question}}
          ...
          @if(count($study->questions) > 0)
            @if (!is_null($question->class_note))
              <tr>
                <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px; padding-top:15px">
                    <singleline>
                      <div mc:edit Simpli>
          ...
          <tr>
            <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px; padding-top:15px">
                <singleline>
                  <div mc:edit Simpli>
                    @if (!is_null($study->class_note))
                      @if ($study->class_note == "simpleNote")
                        <div class="form-group mt-3">
                          <label class="form-check-label" for="simpleNote" style="font-size: 14px;">
                            {!! nl2br($study->note) !!}                          
                          </label>
          ...
          <tr>
            <td colspan="5" height="1" Simpli style="font-size:1px;line-height:1px; border-bottom: 1px solid #DDDDDD;">&nbsp;</td>
          </tr>
        </table>
        <!-- content -->
      </td>
              ...
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr>
                  <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                      <singleline>
                        <div mc:edit Simpli>
                          El tiempo estimado del estudio es de:
                        </div>
                      </singleline>
                  </td>
                </tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tr>
                <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit Simpli>
                        El total de tus estudios será de:
                      </div>
                    </singleline>
                </td>
              </tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
                ...
                <td  class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="10"></td>
                      <td align="center">
                        <a href="https://www.facebook.com/ddu.slp" target="_blank">
                          <img style="width:36px;border:0px;display: inline!important;" src="https://app.ddu.mx/image/Facebook.png" width="36" border="0" editable="true" Simpli data-image-edit  Simpli alt="icon">
                        </a>
                      </td>
                      <td width="10"></td>
                    </tr>
                ...
                <td  class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="10"></td>
                      <td align="center">
                        <a href="https://www.instagram.com/ddu.slp/" target="_blank">
                          <img style="width:36px;border:0px;display: inline!important;" src="https://app.ddu.mx/image/Instagram.png" width="36" border="0" editable="true" Simpli data-image-edit  Simpli alt="icon">
                        </a>
                      </td>
                      <td width="10"></td>
                    </tr>
                ...
                <td  class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="10"></td>
                      <td align="center">
                        <a href="https://www.ddu.mx/" target="_blank">
                          <img style="width:36px;border:0px;display: inline!important;" src="https://app.ddu.mx/image/Web.png" width="36" border="0" editable="true" Simpli data-image-edit  Simpli alt="icon">
                        </a>
                      </td>
                      <td width="10"></td>
                    </tr>
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="https://app.ddu.mx/image/azul200.png" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row mt-2" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:480;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <multiline>
                <div mc:edit Simpli>
                  <a href="https://www.happeningnm.com" target="_blank" style="font-family: 'Catamaran',Arial,Helvetica,sans-serif; font-size: 14px; line-height: 24px; font-weight: 480; font-style: normal; color: #666666; letter-spacing: 0px;">Desarrollado por Happening</a>
                </div>
            </multiline>
          </td>
        </tr>
